...
namespace DelaunatorSharp
{
    public class Delaunator
    {
      ...
      {
         List<IPoint> pts = points.ToList();
         pts = pts.Skip(1).ToList();
         pts.Add(pts.FirstOrDefault());
         return points.Zip(pts, (a, b) => new Edge(0, a, b)).OfType<IEdge>();
         //return points.Zip(points.Skip(1).Append(points.FirstOrDefault()), (a, b) => new Edge(0, a, b)).OfType<IEdge>();
      }
